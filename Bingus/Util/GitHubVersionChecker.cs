...
namespace Bingus.Util
{
    public class GitHubVersionChecker
    {
        private const string GITHUB_API_URL = "https://api.github.com/repos/awsker/Bingus/releases";
        ...
        public GitHubVersionChecker(Version currentVersion)
        {
            ...
            _httpClient.DefaultRequestHeaders.UserAgent.Add(
                new ProductInfoHeaderValue("Bingus-VersionChecker", "1.0"));
        }
