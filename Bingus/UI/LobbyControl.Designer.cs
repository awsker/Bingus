namespace Bingus.UI
{
    partial class LobbyControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._scoreboardControl = new Bingus.UI.ScoreboardControl();
            this._logBoxBorderPanel = new System.Windows.Forms.Panel();
            this._logTextBox = new Bingus.UI.RichTextBoxCustom();
            ...
            this._bingoControl = new Bingus.UI.BingoControl();
            this.adminControl1 = new Bingus.UI.AdminControl();
            this._clientList = new Bingus.UI.ClientListControl();
